    ...
    return (
        <div className={classes.homeContainer}>
            ...
            <div className={classes.contentContainer}>
                <video autoPlay muted loop id="myVideo" className={classes.backgroundVideo}>
                ...
                <div className={classes.safeRouteContainer}>
                    ...
                    <p>
                        Welcome to SafeRoute - your trusted companion for campus safety. With SafeRoute, we've engineered a solution to prioritize students' safety by providing real-time tracking and visualizing crime-heavy areas on campus. SafeRoute alerts users when they approach danger-prone
                        zones, enabling proactive route planning for safer journeys.{" "}
                    </p>
                </div>
