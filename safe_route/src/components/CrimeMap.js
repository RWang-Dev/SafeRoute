...
const CrimeMap = ({ data }) => {
  ...
  const getMarkerSeverity = (severityScore) => {
    if (severityScore < 50) {
      return ["yellow", 15];
      ...
      <div className={classes.container}>
        ...
        >
          ...
          <div className={classes.toggleButtons}>
            <button
              className={classes.showMyLocationButton}
                ...
                {data.map((crime) => (
                  <Marker
                    ...
                    icon={{
                      ...
                      fillColor: getMarkerSeverity(
                        crime["Total Severity Score"]
                      )[0],
                      fillOpacity: 0.55,
                      scale: getMarkerSeverity(
                        crime["Total Severity Score"]
                      )[1],
                      strokeColor: "black",
                      strokeWeight: 1,
